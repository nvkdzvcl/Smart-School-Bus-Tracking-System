          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <CardTitle className="text-base">Trip Status</CardTitle>
                ...
                <p className="text-sm text-muted-foreground">{tripSession}</p>
                <p className="text-sm text-muted-foreground">{format(tripDate, "dd/MM/yyyy")}</p>
                <p className="text-sm text-muted-foreground">{format(actualStartTime, "dd/MM/yyyy")}</p>
                <p className="text-sm text-muted-foreground">{format(actualEndTime, "dd/MM/yyyy")}</p>
