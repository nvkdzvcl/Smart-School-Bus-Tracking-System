...
export default function ParentTrackingPage() {
  ...
  // Mock data
  const busLocation = { lat: 10.7769, lng: 106.7009, speed: 35, heading: 45 }
  const route = {
    stops: [
  ...
  const tripInfo = { driver: "Trần Văn Bình", phone: "0912-345-678", licensePlate: "51B-12345", studentsOnBoard: 12, totalStudents: 15 }
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-full h-full">
                ...
                <svg className="absolute inset-0 w-full h-full" style={{ zIndex: 1 }}>
                  <path d="M 50 250 Q 150 200, 250 150 T 450 50" stroke="#3b82f6" strokeWidth="3" fill="none" strokeDasharray="5,5" opacity="0.6" />
                </svg>

                {/* Stops */}
                <div className="absolute top-[250px] left-[50px] -translate-x-1/2 -translate-y-1/2" style={{ zIndex: 2 }}>
                  <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center shadow-lg">
                    <Home className="w-4 h-4 text-white" />
                  </div>
                </div>
                <div className="absolute top-[50px] right-[50px] -translate-x-1/2 -translate-y-1/2" style={{ zIndex: 2 }}>
                ...
                <div className="absolute top-[150px] left-[250px] -translate-x-1/2 -translate-y-1/2" style={{ zIndex: 3 }}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Badge variant="outline" className="font-mono text-xs">{tripInfo.licensePlate}</Badge>
                </div>
              </div>
                  ...
                  <div className="flex flex-col items-center">
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center ${
                        stop.status === "completed" ? "bg-green-500" : stop.status === "current" ? "bg-primary" : "bg-muted"
                      }`}
                    >
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Xe dự kiến đến trong 5 phút. Vui lòng chuẩn bị sẵn sàng.</p>
              </div>
            </div>
          </CardContent>
        </Card>
