  ...
  const [students, setStudents] = useState<Student[]>([
    {
      ...
      name: "Nguyễn Văn An",
      grade: "Lớp 3A",
      pickupLocation: "123 Đường Lê Lợi, Quận 1",
      dropoffLocation: "Trường Tiểu học ABC",
      status: "not-picked",
    },
    {
      id: 2,
      name: "Trần Thị Bình",
      grade: "Lớp 4B",
      pickupLocation: "456 Đường Nguyễn Huệ, Quận 1",
      dropoffLocation: "Trường Tiểu học ABC",
      status: "not-picked",
    },
    {
      ...
      name: "Lê Văn Cường",
      grade: "Lớp 5C",
      pickupLocation: "789 Đường Pasteur, Quận 1",
      dropoffLocation: "Trường Tiểu học ABC",
      status: "not-picked",
    },
    {
      ...
      name: "Phạm Thị Dung",
      grade: "Lớp 2A",
      pickupLocation: "321 Đường Hai Bà Trưng, Quận 1",
      dropoffLocation: "Trường Tiểu học ABC",
      status: "not-picked",
    },
    {
      ...
      name: "Hoàng Văn Em",
      grade: "Lớp 3B",
      pickupLocation: "654 Đường Trần Hưng Đạo, Quận 1",
      dropoffLocation: "Trường Tiểu học ABC",
      status: "not-picked",
    },
  ])
      ...
      students.map((student) =>
        student.id === studentId
          ? {
              ...student,
              status: "picked-up",
              pickupTime: new Date().toLocaleTimeString("vi-VN", { hour: "2-digit", minute: "2-digit" }),
            }
          : student,
      ),
    )
      ...
      students.map((student) =>
        student.id === studentId
          ? {
              ...student,
              status: "dropped-off",
              dropoffTime: new Date().toLocaleTimeString("vi-VN", { hour: "2-digit", minute: "2-digit" }),
            }
          : student,
      ),
    )
